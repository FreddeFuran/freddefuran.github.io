      ...
      >
        ...
        <div className={`${previewMode === "mobile" ? "order-2" : featured ? "order-1" : "order-2"} flex flex-col justify-center`}>
          ...
          <div className="mt-7 flex items-center gap-4">
            <button className="border border-white/10 bg-white/5 px-5 py-2.5 text-sm text-zinc-100 transition hover:bg-white/10">
              Read More
            </button>
          </div>
        </div>
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#070709] text-zinc-200">
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        {hoveredBackground && !backgrounds.includes(hoveredBackground) && (
          <img
            src={hoveredBackground}
            alt=""
            className="absolute inset-0 h-full w-full object-cover opacity-60 transition-opacity duration-[2200ms]"
          />
        )}
      ...
      >
          ...
          <div className="flex items-center justify-between px-6 py-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden gap-6 text-sm text-zinc-400 md:flex">
                ...
                <a href="#cv" className="transition hover:text-white">CV</a>
              </nav>
            </div>
          </div>
        </header>
        ...
        <RevealSection id="contact" className="mt-10 px-6 py-14" delay={240}>
          <div className="border-t border-white/10 pt-10">
            <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">Contact</p>
            <h2 className="mt-3 text-2xl font-semibold text-white">Get in touch</h2>
            <p className="mt-4 max-w-xl leading-8 text-zinc-300">
              Add your email, GitHub, LinkedIn and CV here once you are ready to publish.
            </p>
          </div>
        </RevealSection>
      </div>
